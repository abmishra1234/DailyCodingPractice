/*
	I don't understood the purpose of this exercise,
	but for making all exercise complete, let's finish this exercise also.
...
int main() {
	PalindromeBrake pb;
	cout << pb.solve("abccba") << endl;
	cout << pb.solve("a") << endl;
	cout << pb.solve("aa") << endl;
	cout << pb.solve("aba") << endl;
